...
.method private connect()V
    ...
    new-instance v5, Ljcifs/netbios/SessionRequestPacket;

    iget-object v7, p0, Ljcifs/netbios/NbtSocket;->calledName:Ljcifs/netbios/Name;

    sget-object v8, Ljcifs/netbios/NbtAddress;->localhost:Ljcifs/netbios/NbtAddress;

    iget-object v8, v8, Ljcifs/netbios/NbtAddress;->hostName:Ljcifs/netbios/Name;

    invoke-direct {v5, v7, v8}, Ljcifs/netbios/SessionRequestPacket;-><init>(Ljcifs/netbios/Name;Ljcifs/netbios/Name;)V

    .line 104
    .local v5, ssp0:Ljcifs/netbios/SessionServicePacket;
    const/4 v7, 0x0

    const/4 v8, 0x0

    invoke-virtual {v5, v0, v8}, Ljcifs/netbios/SessionServicePacket;->writeWireFormat([BI)I
    ...
    .line 106
    iget v7, p0, Ljcifs/netbios/NbtSocket;->soTimeout:I

    invoke-virtual {p0, v7}, Ljcifs/netbios/NbtSocket;->setSoTimeout(I)V

    .line 107
    const/4 v7, 0x0

    invoke-static {v2, v0, v7}, Ljcifs/netbios/SessionServicePacket;->readPacketType(Ljava/io/InputStream;[BI)I
    :try_end_0
    ...
    .line 126
    new-instance v7, Ljcifs/netbios/NbtException;

    invoke-direct {v7, v10, v9}, Ljcifs/netbios/NbtException;-><init>(II)V
    ...
    .end local v5           #ssp0:Ljcifs/netbios/SessionServicePacket;
    .end local v6           #type:I
    :catch_0
    move-exception v3
    ...
    .restart local v5       #ssp0:Ljcifs/netbios/SessionServicePacket;
    ...
    .line 116
    sget-object v7, Ljcifs/netbios/NbtSocket;->log:Ljcifs/util/LogStream;
    ...
    iget-object v9, p0, Ljcifs/netbios/NbtSocket;->address:Ljcifs/netbios/NbtAddress;
    ...
    invoke-direct {v7, v10, v1}, Ljcifs/netbios/NbtException;-><init>(II)V
    ...
    invoke-direct {v7, v10, v8}, Ljcifs/netbios/NbtException;-><init>(II)V
